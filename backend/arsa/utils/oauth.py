...
from arsa.models.auths import Auths
from arsa.models.oauth_sessions import OAuthSessions
from arsa.models.users import Users


from arsa.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from arsa.utils.misc import parse_duration
from arsa.utils.auth import get_password_hash, create_token
...
from arsa.env import GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(f'All groups available in ARSA: {[g.name for g in all_available_groups]}')
