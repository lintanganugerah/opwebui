from arsa.utils.task import prompt_template, prompt_variables_template
...
def remove_arsa_params(params: dict) -> dict:
    """
    Removes ARSA specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with ARSA parameters removed.
    """
    arsa_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_arsa_params(params)
