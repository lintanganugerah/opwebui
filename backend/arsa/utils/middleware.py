...
from arsa.utils.misc import is_string_allowed
from arsa.models.oauth_sessions import OAuthSessions
from arsa.models.chats import Chats
from arsa.models.folders import Folders
from arsa.models.users import Users
from arsa.socket.main import (
    get_event_call,
    get_event_emitter,
)
from arsa.routers.tasks import (
    generate_queries,
    generate_title,
    generate_follow_ups,
...
from arsa.routers.retrieval import (
    process_web_search,
    SearchForm,
)
from arsa.utils.tools import get_builtin_tools
from arsa.routers.images import (
    image_generations,
    CreateImageForm,
    image_edits,
    EditImageForm,
)
from arsa.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)
from arsa.routers.memories import query_memory, QueryMemoryForm

from arsa.utils.webhook import post_webhook
from arsa.utils.files import (
...
from arsa.models.users import UserModel
from arsa.models.functions import Functions
from arsa.models.models import Models

from arsa.retrieval.utils import get_sources_from_items


from arsa.utils.sanitize import sanitize_code
from arsa.utils.chat import generate_chat_completion
from arsa.utils.task import (
    get_task_model_id,
    rag_template,
...
from arsa.utils.tools import (
    get_tools,
    get_updated_tool_function,
    get_terminal_tools,
)
from arsa.utils.access_control import has_connection_access
from arsa.utils.plugin import load_function_module_by_id
from arsa.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)
from arsa.utils.code_interpreter import execute_code_jupyter
from arsa.utils.payload import apply_system_prompt_to_body
from arsa.utils.response import normalize_usage
from arsa.utils.mcp.client import MCPClient
...
from arsa.utils.headers import include_user_info_headers
from arsa.constants import TASKS
...
def serialize_output(output: list) -> str:
    ...
    for idx, item in enumerate(output):
        ...
        elif item_type == 'arsa:code_interpreter':
...
async def process_chat_payload(request, form_data, user, metadata, model):
    ...
    available_skills = []
    if all_skill_ids:
        from arsa.models.skills import Skills as SkillsModel
        ...
        async def response_handler(response, events):
            def tag_output_handler(content_type, tags, output):
                ...
                output_type_map = {
                    ...
                    'code_interpreter': 'arsa:code_interpreter',
                }
                ...
                if last_type == 'message':
                    ...
                    for start_tag, end_tag in tags:
                        ...
                        if match:
                            ...
                            elif output_item_type == 'arsa:code_interpreter':
                                output.append(
                                    {
                                        'type': 'arsa:code_interpreter',
                                        'id': output_id('ci'),
                                        'status': 'in_progress',
                                        'start_tag': start_tag,
                                        'end_tag': end_tag,
                    ...
                    or (last_type == 'arsa:code_interpreter' and content_type == 'code_interpreter')
                    ...
                    elif last_type == 'arsa:code_interpreter':
            ...
            try:
                                    ...
                                    if value:
                                        ...
                                        inside_tag_block = (
                                            ...
                                            and (
                                                ...
                                                or last_item_type == 'arsa:code_interpreter'
                                                or (
                                        ...
                                        if inside_tag_block:
                                            ...
                                            if last_item_type == 'arsa:code_interpreter':
                ...
                if DETECT_CODE_INTERPRETER:
                    ...
                    while output and output[-1].get('type') == 'arsa:code_interpreter' and retries < MAX_RETRIES:
                        await event_emitter(
                            {
                                'type': 'chat:completion',
                                'data': {
