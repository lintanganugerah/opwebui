...
from arsa.utils import logger
from arsa.utils.audit import AuditLevel, AuditLoggingMiddleware
from arsa.utils.logger import start_logger
...
from arsa.internal.db import ScopedSession, engine, get_session

from arsa.models.functions import Functions
from arsa.models.models import Models
from arsa.models.users import UserModel, Users
...
from arsa.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
    get_filtered_models,
)
from arsa.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
)
from arsa.utils.actions import chat_action as chat_action_handler
from arsa.utils.embeddings import generate_embeddings
from arsa.utils.middleware import (
    build_chat_response_context,
    process_chat_payload,
    process_chat_response,
)
from arsa.utils.tools import set_tool_servers, set_terminal_servers

from arsa.utils.auth import (
    get_license_data,
...
from arsa.utils.plugin import install_tool_and_function_dependencies
from arsa.utils.oauth import (
...
from arsa.utils.security_headers import SecurityHeadersMiddleware
from arsa.utils.redis import get_redis_connection

from arsa.tasks import (
...
from arsa.utils.redis import get_sentinels_from_env
...
if ENABLE_OTEL:
    from arsa.utils.telemetry.setup import setup as setup_opentelemetry
...
from arsa.utils.access_control import migrate_access_control
        ...
        if request.method == 'GET':
            ...
            if 'shared' in query_params and len(query_params['shared']) > 0:
                ...
                if text:
                    ...
                    if urls:
                        from arsa.retrieval.loaders.youtube import _parse_video_id
...
from arsa.utils.anthropic import (
...
async def generate_messages(
    ...
    All models configured in ARSA are accessible via this endpoint.
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                'https://api.github.com/repos/arsa/arsa/releases/latest',
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for ARSA.
