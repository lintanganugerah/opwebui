...
def version_callback(value: bool) -> None:
    if value:
        from arsa.env import VERSION

        typer.echo(f'ARSA version: {VERSION}')
        raise typer.Exit()
...
def serve(
    ...
    import arsa.main  # noqa: F401
    from arsa.env import UVICORN_WORKERS  # Import the workers setting
