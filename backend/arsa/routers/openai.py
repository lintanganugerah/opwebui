...
from arsa.utils.payload import (
...
from arsa.utils.anthropic import is_anthropic_url, get_anthropic_models
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else 'ARSA: Server Connection Error',
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail='ARSA: Server Connection Error')
            except Exception as e:
...
def _normalize_stored_item(item: dict) -> dict:
    ...
    ARSA stores extra bookkeeping fields (``id``, ``status``,
...
async def generate_chat_completion(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail='ARSA: Server Connection Error',
        )
    finally:
        if not streaming:
