...
from arsa.models.prompt_history import PromptHistories
from arsa.models.access_grants import AccessGrantModel, AccessGrants
...
class PromptsTable:
    ...
    def search_prompts(
        ...
        with get_db_context(db) as db:
            from arsa.models.users import User, UserModel
