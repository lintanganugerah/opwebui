# Inventory lokasi branding OpenWebUI

## A. Source of truth / config brand
- `backend/open_webui/env.py:128-132` — `WEBUI_NAME`, `WEBUI_FAVICON_URL`
...
- `backend/open_webui/main.py:2138-2166` — backend config expose `license_metadata` & `metadata.auth_logo_position`
- `backend/open_webui/config.py:884-910` — legacy custom branding via `CUSTOM_NAME`
...
- `src/app.html:106` — hardcoded initial `<title>Open WebUI</title>`
- `src/routes/+layout.svelte:1033-1041` — runtime `<title>`, description, apple web app title, opensearch title
- `static/opensearch.xml:2-6` — Open WebUI short name / description
- `static/static/site.webmanifest:2-16` — static manifest brand name
- `backend/open_webui/main.py:2456-2482` — dynamic manifest payload
- `backend/open_webui/static/site.webmanifest:2-16` — backend manifest copy
...
## E. UI yang masih hardcoded Open WebUI / openwebui.com
...
- `backend/open_webui/main.py:712` — FastAPI title
- `backend/open_webui/env.py:132` — remote favicon URL
- `backend/open_webui/utils/webhook.py:36-42` — webhook card image
- `backend/open_webui/routers/openai.py:155-156` — OpenRouter referer/title
- `backend/open_webui/retrieval/web/external.py:27`
- `backend/open_webui/retrieval/web/searxng.py:68`
- `backend/open_webui/retrieval/web/yacy.py:62`
- `backend/open_webui/retrieval/web/yandex.py:45`
- `backend/open_webui/retrieval/loaders/external_web.py:33`
- `backend/open_webui/routers/ollama.py` — error copy
- `backend/open_webui/routers/openai.py` — error copy
- `backend/open_webui/routers/audio.py` — error copy
